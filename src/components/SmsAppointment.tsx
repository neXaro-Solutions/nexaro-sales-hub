...
export function SmsAppointment({task,demo}:{task:Task;demo:boolean}){
 ...
 return <section className="nx-sms-panel" aria-label="E-Mail-Terminbestätigung" style={{border:"1px solid #d9e4d6",borderRadius:14,padding:16,marginTop:16,background:"#f8fbf6"}}>
  <strong>✉️ E-Mail-Terminbestätigung · 07:30 Uhr</strong>
  <p className="hint">Am Termintag, nur für Termine mit Kunde und gültiger E-Mail-Adresse. Auch frühe Termine werden ausschließlich um 07:30 Uhr berücksichtigt; bereits vergangene Termine erhalten keine SMS.</p>
  ...
  <p role="status"><strong>Status: {!row?.enabled?"Nicht für E-Mail freigegeben":names[row?.status||"planned"]||"Noch nicht eingerichtet"}</strong></p>
